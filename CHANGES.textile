...
- gestion des fichiers de config identique sous win et linux ($HOME). On cherche d'abord startpilot.yml, puis .startpilot

----------------------------------------------------------------------
h1. 2010-11-06 v. 0.1

- gestion des sources sous "https://github.com/danc/startpilot":https://github.com/danc/startpilot
- ajout Additions (reduire-photos.exe et Trimartolod_data.exe)

----------------------------------------------------------------------
h1. 2010-11-04 v. 0.0.9

- correction bug librairie syncftp (ftp.passive = true) à ameliorer et remonter au développeur TODO
- upload possible des fichiers sur le site (sources et html), ce qui permet de mettre le site à jour en direct
- le mot de passe ftp doit être connu et saisi à la main (TODO : le masquer)
TODO :
